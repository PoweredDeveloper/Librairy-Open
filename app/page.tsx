  ...
  return (
    <div className='flex justify-between items-center flex-auto'>
      <div className='flex flex-col gap-3 ml-32'>
          <h1 className='text-left text-brown-900 text-7xl font-bold'>
            Приобретите <span className='text-orange-400'>свою</span><br />
            Любимую <span className='text-orange-400'>книгу</span><br />
            Здесь!
          </h1>
          <p className='mt-3'>Онлайн библиотека уже с ИИ. Испытайте чтение по новому</p>
      ...
      <div className='relative overflow-hidden h-full'>
        <div className='absolute bottom-0 right-0 w-1/2 aspect-square bg-[radial-gradient(circle at 100% bottom, rgba(255,154,84,1) 10%, rgba(255,255,255,0) 90%)]' />
      </div>
    </div>
  )
}
