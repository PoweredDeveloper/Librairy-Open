  ...
  return (
    <div className='flex md:justify-between justify-center items-center flex-auto'>
      <div className='flex flex-col items-center md:items-start gap-3 md:ml-16 lg:ml-32'>
          ...
          <p className='mt-3 text-center flex items-center lg:text-left text-brown-900'>Онлайн библиотека уже с ИИ.<span className='hidden sm:block'>Испытайте чтение по новому</span></p>
